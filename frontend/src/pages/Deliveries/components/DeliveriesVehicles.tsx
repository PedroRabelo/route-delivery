...
export function DeliveriesVehicle({ trucks, handleFilterDeliveryPoints, handleFetchDeliveryVehicles }: Props) {
        ...
        <dl className="mt-0 grid grid-cols-1 gap-6 sm:grid-cols-6">
          <div className="overflow-hidden rounded-lg bg-gray-100 px-4 py-5 shadow sm:p-4">
            <dd className="mt-1 text-base font-semibold tracking-tight text-gray-900">
              {trucks?.length} Veículos utilizados
            </dd>
          </div>
          <div className="overflow-hidden rounded-lg bg-gray-100 px-4 py-5 shadow sm:p-4">
            <dd className="mt-1 text-base font-semibold tracking-tight text-gray-900">
              {trucks?.length && formatNumber(getSumByKey(trucks, 'capacidade'))} Kg Cap.
            </dd>
          </div>
          <div className="overflow-hidden rounded-lg bg-gray-100 px-4 py-5 shadow sm:p-4">
            <dd className="mt-1 text-base font-semibold tracking-tight text-gray-900">
          ...
          <div className="overflow-hidden rounded-lg bg-gray-100 px-4 py-5 shadow sm:p-4">
            <dd className="mt-1 text-base font-semibold tracking-tight text-gray-900">
              {trucks?.length && formatNumber(getSumByKey(trucks, 'peso'))} Kg Carga total
            </dd>
          </div>
          <div className="overflow-hidden rounded-lg bg-gray-100 px-4 py-5 shadow sm:p-4">
            <dd className="mt-1 text-base font-semibold tracking-tight text-gray-900">
              {trucks?.length && formatCurrency(getSumByKey(trucks, 'valor'))} Total
            </dd>
          </div>
        </dl>
      </div>
